...
if(isset($_POST['submit'])){
        ...
        $sql = "UPDATE emp_record SET employeeName='$employeeName',id='$id', department='$department', salary='$salary',
        ...
        if($execute) {
            echo "<script>window.open('PhpView.php?id=Record Updated Successfully', '_self')</script>";
        }
}
...
<div class="">
    <form class="" action="PhpUpdate.php?id=<?php echo $searchQueryParameter;?>" method="post">
        <fieldset>
